...
// Example widget data and components (reuse from DashboardWidgets)
const lineData = [
  ...
  <Box sx={{ flex: 1, p: 4, bgcolor: '#f3f6fa', minHeight: '100vh' }}>
    ...
    <Grid container spacing={3} mb={2}>
      <Grid item xs={12} md={8}>
        <Paper elevation={2} sx={{ borderRadius: 3, p: 3, height: 350 }}>
          <Typography variant="h6" fontWeight="bold" mb={2}>Visitors Trend</Typography>
      ...
      <Grid item xs={12} md={4}>
        <Paper elevation={2} sx={{ borderRadius: 3, p: 3, height: 350, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          <Typography variant="h6" fontWeight="bold" mb={2}>Project Completion</Typography>
    ...
    <Grid container spacing={3}>
      <Grid item xs={12} md={6}>
        <Paper elevation={2} sx={{ borderRadius: 3, p: 3, height: 320 }}>
          <Typography variant="h6" fontWeight="bold" mb={2}>Global Sales by Top Locations</Typography>
          <ModernTable columns={columns} data={tableData} />
        </Paper>
      </Grid>
      <Grid item xs={12} md={6}>
        <Paper elevation={2} sx={{ borderRadius: 3, p: 3, height: 320, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          <Typography variant="h6" fontWeight="bold" mb={2}>New Users</Typography>
          <ResponsiveContainer width="100%" height={180}>
            <PieChart>
...
export default DashboardWidgetsConfig; 